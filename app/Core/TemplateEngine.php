...
class TemplateEngine
{
    ...
    public function __construct(string $templateDir, string $cacheDir, array $config = [])
    {
        ...
        $this->globals = [
            ...
            'site_user_group' => SessionManager::get('user_group'),
            'site_user_group_slug' => SessionManager::get('user_group_slug'),
            'site_user_can_access_panel' => SessionManager::get('user_can_access_panel', 0),
