...
class SettingsRegistry
{
    ...
    public static function getCategoryDefinitions(): array
    {
        return [
            ...
            'blog' => [
                'title' => 'Blog',
                'description' => 'Controls blog post pagination, comment sizing, and staff publishing defaults.',
                'icon' => 'fa-newspaper',
                'sort_order' => 35,
                'is_system' => 1,
            ],
    ...
    public static function getSettingDefinitions(): array
    {
        return [
            ...
            'blog.posts_per_page' => [
                ...
                'description' => 'Sets how many published blog posts appear on each public blog page before pagination is used.',
                'type' => 'int',
                'input' => 'number',
                'min' => 1,
                'max' => 200,
                'help' => 'Lower values keep the blog landing page lighter when posts become longer.',
                'default' => 10,
                'sort_order' => 10,
                'is_system' => 1,
            ],
            'blog.comments_per_page' => [
                'category' => 'blog',
                'title' => 'Blog Comments Per Page',
                'description' => 'Controls how many comments appear at once under a published blog post before pagination is used.',
                'type' => 'int',
                'input' => 'number',
                'min' => 1,
                'max' => 200,
                'help' => 'Higher values expose more discussion at once but can make long comment threads heavier.',
                'default' => 10,
                'sort_order' => 20,
                'is_system' => 1,
            ],
